"""
Django settings for blackmanja project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure--gy2+%aqr-v^+7-xg3*%fo!1^xx(pw%k7)63yo-wq8y1!6nv-h')
...
WSGI_APPLICATION = 'blackmanja.wsgi.application'
